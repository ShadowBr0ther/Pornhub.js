...
var require_stats = __commonJS({
  "../../node_modules/undici/lib/util/stats.js"(exports, module2) {
    "use strict";
    var {
      kConnected,
      kPending,
...
var require_wrap_handler = __commonJS({
  "../../node_modules/undici/lib/handler/wrap-handler.js"(exports, module2) {
    "use strict";
    ...
    module2.exports = (_a = class {
      ...
      onUpgrade(statusCode, rawHeaders, socket) {
        var _a2, _b;
        return (_b = (_a2 = __privateGet(this, _handler)).onUpgrade) == null ? void 0 : _b.call(_a2, statusCode, rawHeaders, socket);
      }
      onData(data) {
        var _a2, _b;
        return (_b = (_a2 = __privateGet(this, _handler)).onData) == null ? void 0 : _b.call(_a2, data);
      }
      onComplete(trailers) {
        var _a2, _b;
        return (_b = (_a2 = __privateGet(this, _handler)).onComplete) == null ? void 0 : _b.call(_a2, trailers);
      }
      onError(err) {
        var _a2, _b;
        ...
        return (_b = (_a2 = __privateGet(this, _handler)).onError) == null ? void 0 : _b.call(_a2, err);
      }
      // Wrap Interface
      onRequestStart(controller, context) {
        var _a2, _b;
        (_b = (_a2 = __privateGet(this, _handler)).onConnect) == null ? void 0 : _b.call(_a2, (reason) => controller.abort(reason), context);
      }
      ...
      onResponseData(controller, data) {
        var _a2, _b;
        if (((_b = (_a2 = __privateGet(this, _handler)).onData) == null ? void 0 : _b.call(_a2, data)) === false) {
          controller.pause();
        }
      }
...
var require_unwrap_handler = __commonJS({
  "../../node_modules/undici/lib/handler/unwrap-handler.js"(exports, module2) {
    "use strict";
    var { parseHeaders } = require_util();
    var { InvalidArgumentError } = require_errors();
    var kResume = Symbol("resume");
    var _paused, _reason, _aborted, _abort, _a;
    var UnwrapController = class {
      ...
      resume() {
        ...
        if (__privateGet(this, _paused)) {
          ...
          (_a3 = this[kResume]) == null ? void 0 : _a3.call(this);
        }
      }
      abort(reason) {
    ...
    _abort = new WeakMap();
    var _handler, _controller, _a2;
    module2.exports = (_a2 = class {
      constructor(handler) {
        __privateAdd(this, _handler, void 0);
      ...
      static unwrap(handler) {
        return !handler.onRequestStart ? handler : new _a2(handler);
      }
      onConnect(abort, context) {
        var _a3, _b;
      ...
      onUpgrade(statusCode, rawHeaders, socket) {
        var _a3, _b;
        (_b = (_a3 = __privateGet(this, _handler)).onRequestUpgrade) == null ? void 0 : _b.call(_a3, __privateGet(this, _controller), statusCode, parseHeaders(rawHeaders), socket);
      }
      onHeaders(statusCode, rawHeaders, resume, statusMessage) {
        var _a3, _b;
        __privateGet(this, _controller)[kResume] = resume;
        (_b = (_a3 = __privateGet(this, _handler)).onResponseStart) == null ? void 0 : _b.call(_a3, __privateGet(this, _controller), statusCode, parseHeaders(rawHeaders), statusMessage);
        return !__privateGet(this, _controller).paused;
      }
      onData(data) {
        var _a3, _b;
        (_b = (_a3 = __privateGet(this, _handler)).onResponseData) == null ? void 0 : _b.call(_a3, __privateGet(this, _controller), data);
        return !__privateGet(this, _controller).paused;
      }
      onComplete(rawTrailers) {
        var _a3, _b;
        (_b = (_a3 = __privateGet(this, _handler)).onResponseEnd) == null ? void 0 : _b.call(_a3, __privateGet(this, _controller), parseHeaders(rawTrailers));
      }
      onError(err) {
        var _a3, _b;
        if (!__privateGet(this, _handler).onResponseError) {
          throw new InvalidArgumentError("invalid onError method");
        }
        (_b = (_a3 = __privateGet(this, _handler)).onResponseError) == null ? void 0 : _b.call(_a3, __privateGet(this, _controller), err);
      }
    }, _handler = new WeakMap(), _controller = new WeakMap(), _a2);
  }
});
  ...
  "../../node_modules/undici/lib/web/fetch/formdata.js"(exports, module2) {
    ...
    var _FormData = class _FormData {
      ...
      append(name, value, filename = void 0) {
        ...
        __privateGet(this, _state).push(entry);
      }
      delete(name) {
        webidl.brandCheck(this, _FormData);
        ...
        name = webidl.converters.USVString(name);
        __privateSet(this, _state, __privateGet(this, _state).filter((entry) => entry.name !== name));
      }
      get(name) {
        webidl.brandCheck(this, _FormData);
        ...
        webidl.argumentLengthCheck(arguments, 1, prefix);
        name = webidl.converters.USVString(name);
        const idx = __privateGet(this, _state).findIndex((entry) => entry.name === name);
        if (idx === -1) {
          return null;
        }
        return __privateGet(this, _state)[idx].value;
      }
      getAll(name) {
        webidl.brandCheck(this, _FormData);
        ...
        webidl.argumentLengthCheck(arguments, 1, prefix);
        name = webidl.converters.USVString(name);
        return __privateGet(this, _state).filter((entry) => entry.name === name).map((entry) => entry.value);
      }
      has(name) {
        webidl.brandCheck(this, _FormData);
        ...
        webidl.argumentLengthCheck(arguments, 1, prefix);
        name = webidl.converters.USVString(name);
        return __privateGet(this, _state).findIndex((entry) => entry.name === name) !== -1;
      }
      set(name, value, filename = void 0) {
        ...
        const entry = makeEntry(name, value, filename);
        const idx = __privateGet(this, _state).findIndex((entry2) => entry2.name === name);
        if (idx !== -1) {
          __privateSet(this, _state, [
            ...__privateGet(this, _state).slice(0, idx),
            entry,
            ...__privateGet(this, _state).slice(idx + 1).filter((entry2) => entry2.name !== name)
          ]);
        } else {
          __privateGet(this, _state).push(entry);
        }
      ...
      [nodeUtil.inspect.custom](depth, options) {
        const state = __privateGet(this, _state).reduce((a, b) => {
          if (a[b.name]) {
      ...
      static getFormDataState(formData) {
        return __privateGet(formData, _state);
      }
      /**
       * @param {FormData} formData
       * @param {any[]} newState
      ...
      static setFormDataState(formData, newState) {
        __privateSet(formData, _state, newState);
      }
    };
    _state = new WeakMap();
...
var require_client_h1 = __commonJS({
  "../../node_modules/undici/lib/dispatcher/client-h1.js"(exports, module2) {
    ...
    function onHttpSocketReadable() {
      var _a;
      (_a = this[kParser]) == null ? void 0 : _a.readMore();
    }
  ...
  "../../node_modules/undici/lib/dispatcher/proxy-agent.js"(exports, module2) {
    ...
    var ProxyClient = class extends DispatcherBase {
      constructor(origin, opts) {
        ...
        __privateSet(this, _client, new Client(origin, opts));
      }
      async [kClose]() {
      ...
      async [kDispatch](opts, handler) {
        ...
        if (method === "CONNECT") {
          __privateGet(this, _client)[kConnector](
            {
              origin,
              ...
              servername: ((_a = this[kProxyTls]) == null ? void 0 : _a.servername) || opts.servername
            },
            (err, socket) => {
              if (err) {
    ...
    _client = new WeakMap();
    var _getUrl, getUrl_fn, _shouldConnect, shouldConnect_fn;
    var ProxyAgent = class extends DispatcherBase {
      constructor(opts) {
        ...
        __privateAdd(this, _shouldConnect);
      ...
      dispatch(opts, handler) {
        ...
        if (!__privateMethod(this, _shouldConnect, shouldConnect_fn).call(this, new URL2(opts.origin))) {
    ...
    _shouldConnect = new WeakSet();
    shouldConnect_fn = function(uri) {
  ...
  "../../node_modules/undici/lib/handler/retry-handler.js"(exports, module2) {
    ...
    var RetryHandler = class _RetryHandler {
      ...
      onRequestStart(controller, context) {
        var _a, _b;
        if (!this.headersSent) {
          (_b = (_a = this.handler).onRequestStart) == null ? void 0 : _b.call(_a, controller, context);
        }
      }
      onRequestUpgrade(controller, statusCode, headers, socket) {
        var _a, _b;
      ...
      onResponseStart(controller, statusCode, headers, statusMessage) {
        ...
        if (statusCode >= 300) {
          if (this.retryOpts.statusCodes.includes(statusCode) === false) {
            ...
            (_b = (_a = this.handler).onResponseStart) == null ? void 0 : _b.call(
              _a,
              controller,
              statusCode,
              headers,
      ...
      onResponseData(controller, chunk) {
        ...
        (_b = (_a = this.handler).onResponseData) == null ? void 0 : _b.call(_a, controller, chunk);
      }
      onResponseEnd(controller, trailers) {
        var _a, _b;
        this.retryCount = 0;
        return (_b = (_a = this.handler).onResponseEnd) == null ? void 0 : _b.call(_a, controller, trailers);
      }
      onResponseError(controller, err) {
        var _a, _b;
        if ((controller == null ? void 0 : controller.aborted) || isDisturbed(this.opts.body)) {
          (_b = (_a = this.handler).onResponseError) == null ? void 0 : _b.call(_a, controller, err);
          return;
        }
        ...
        function onRetry(err2) {
          ...
          if (err2 != null || (controller == null ? void 0 : controller.aborted) || isDisturbed(this.opts.body)) {
            return (_b2 = (_a2 = this.handler).onResponseError) == null ? void 0 : _b2.call(_a2, controller, err2);
          }
          if (this.start !== 0) {
...
var require_h2c_client = __commonJS({
  "../../node_modules/undici/lib/dispatcher/h2c-client.js"(exports, module2) {
    "use strict";
    ...
    var Client = require_client();
    var DispatcherBase = require_dispatcher_base();
    var _client, _buildConnector, buildConnector_fn;
    var H2CClient = class extends DispatcherBase {
      constructor(origin, clientOpts) {
        super();
        __privateAdd(this, _buildConnector);
        __privateAdd(this, _client, null);
        if (typeof origin === "string") {
          origin = new URL(origin);
        }
        ...
        __privateSet(this, _client, new Client(origin, {
          ...opts,
          connect: __privateMethod(this, _buildConnector, buildConnector_fn).call(this, connect2),
...
var require_readable = __commonJS({
  "../../node_modules/undici/lib/api/readable.js"(exports, module2) {
    ...
    function isLocked(bodyReadable) {
      var _a;
      return ((_a = bodyReadable[kBody]) == null ? void 0 : _a.locked) === true || bodyReadable[kConsume] !== null;
    }
...
var require_mock_call_history = __commonJS({
  "../../node_modules/undici/lib/mock/mock-call-history.js"(exports, module2) {
    "use strict";
...
var require_decorator_handler = __commonJS({
  "../../node_modules/undici/lib/handler/decorator-handler.js"(exports, module2) {
    ...
    var assert = require("assert");
    var WrapHandler = require_wrap_handler();
    var _handler, _onCompleteCalled, _onErrorCalled, _onResponseStartCalled, _a;
    module2.exports = (_a = class {
      constructor(handler) {
        __privateAdd(this, _handler, void 0);
        ...
        __privateSet(this, _handler, WrapHandler.wrap(handler));
      }
      onRequestStart(...args) {
        var _a2, _b;
        (_b = (_a2 = __privateGet(this, _handler)).onRequestStart) == null ? void 0 : _b.call(_a2, ...args);
      }
      onRequestUpgrade(...args) {
        var _a2, _b;
        assert(!__privateGet(this, _onCompleteCalled));
        assert(!__privateGet(this, _onErrorCalled));
        return (_b = (_a2 = __privateGet(this, _handler)).onRequestUpgrade) == null ? void 0 : _b.call(_a2, ...args);
      }
      onResponseStart(...args) {
        var _a2, _b;
        assert(!__privateGet(this, _onCompleteCalled));
        assert(!__privateGet(this, _onErrorCalled));
        assert(!__privateGet(this, _onResponseStartCalled));
        __privateSet(this, _onResponseStartCalled, true);
        return (_b = (_a2 = __privateGet(this, _handler)).onResponseStart) == null ? void 0 : _b.call(_a2, ...args);
      }
      onResponseData(...args) {
        var _a2, _b;
        assert(!__privateGet(this, _onCompleteCalled));
        assert(!__privateGet(this, _onErrorCalled));
        return (_b = (_a2 = __privateGet(this, _handler)).onResponseData) == null ? void 0 : _b.call(_a2, ...args);
      }
      onResponseEnd(...args) {
        var _a2, _b;
        assert(!__privateGet(this, _onCompleteCalled));
        ...
        return (_b = (_a2 = __privateGet(this, _handler)).onResponseEnd) == null ? void 0 : _b.call(_a2, ...args);
      }
      onResponseError(...args) {
        var _a2, _b;
        __privateSet(this, _onErrorCalled, true);
        return (_b = (_a2 = __privateGet(this, _handler)).onResponseError) == null ? void 0 : _b.call(_a2, ...args);
      }
      /**
       * @deprecated
       */
    ...
    }, _handler = new WeakMap(), _onCompleteCalled = new WeakMap(), _onErrorCalled = new WeakMap(), _onResponseStartCalled = new WeakMap(), _a);
  }
});
...
var require_redirect_handler = __commonJS({
  "../../node_modules/undici/lib/handler/redirect-handler.js"(exports, module2) {
    ...
    var RedirectHandler = class _RedirectHandler {
      ...
      onRequestStart(controller, context) {
        var _a, _b;
        (_b = (_a = this.handler).onRequestStart) == null ? void 0 : _b.call(_a, controller, { ...context, history: this.history });
      }
      onRequestUpgrade(controller, statusCode, headers, socket) {
        var _a, _b;
        (_b = (_a = this.handler).onRequestUpgrade) == null ? void 0 : _b.call(_a, controller, statusCode, headers, socket);
      ...
      onResponseStart(controller, statusCode, headers, statusMessage) {
        ...
        if (!this.location) {
          (_b = (_a = this.handler).onResponseStart) == null ? void 0 : _b.call(_a, controller, statusCode, headers, statusMessage);
          return;
        }
      ...
      onResponseError(controller, error) {
        var _a, _b;
        (_b = (_a = this.handler).onResponseError) == null ? void 0 : _b.call(_a, controller, error);
      }
    };
...
var require_response_error = __commonJS({
  "../../node_modules/undici/lib/interceptor/response-error.js"(exports, module2) {
    "use strict";
    var DecoratorHandler = require_decorator_handler();
    var { ResponseError } = require_errors();
    var _statusCode, _contentType, _decoder, _headers, _body, _checkContentType, checkContentType_fn;
    var ResponseErrorHandler = class extends DecoratorHandler {
      constructor(_opts, { handler }) {
        super(handler);
        __privateAdd(this, _checkContentType);
        __privateAdd(this, _statusCode, void 0);
        __privateAdd(this, _contentType, void 0);
      ...
      onResponseStart(controller, statusCode, headers, statusMessage) {
        ...
        __privateSet(this, _contentType, headers["content-type"]);
        if (__privateGet(this, _statusCode) < 400) {
          return super.onResponseStart(controller, statusCode, headers, statusMessage);
        }
        if (__privateMethod(this, _checkContentType, checkContentType_fn).call(this, "application/json") || __privateMethod(this, _checkContentType, checkContentType_fn).call(this, "text/plain")) {
      ...
      onResponseData(controller, chunk) {
        ...
        __privateSet(this, _body, __privateGet(this, _body) + (((_a = __privateGet(this, _decoder)) == null ? void 0 : _a.decode(chunk, { stream: true })) ?? ""));
      }
      onResponseEnd(controller, trailers) {
        var _a;
        if (__privateGet(this, _statusCode) >= 400) {
          __privateSet(this, _body, __privateGet(this, _body) + (((_a = __privateGet(this, _decoder)) == null ? void 0 : _a.decode(void 0, { stream: false })) ?? ""));
          if (__privateMethod(this, _checkContentType, checkContentType_fn).call(this, "application/json")) {
            try {
          ...
          try {
            err = new ResponseError("Response Error", __privateGet(this, _statusCode), {
...
var require_dump = __commonJS({
  "../../node_modules/undici/lib/interceptor/dump.js"(exports, module2) {
    ...
    var { InvalidArgumentError, RequestAbortedError } = require_errors();
    var DecoratorHandler = require_decorator_handler();
    var _maxSize, _dumped, _size, _controller, _abort, abort_fn;
    var DumpHandler = class extends DecoratorHandler {
      ...
      onRequestStart(controller, context) {
        controller.abort = __privateMethod(this, _abort, abort_fn).bind(this);
      ...
      onResponseError(controller, err) {
        ...
        err = __privateGet(this, _controller).reason ?? err;
        super.onResponseError(controller, err);
      }
      onResponseData(controller, chunk) {
      ...
      onResponseEnd(controller, trailers) {
        ...
        if (__privateGet(this, _controller).aborted === true) {
          super.onResponseError(controller, this.reason);
          return;
        }
        super.onResponseEnd(controller, trailers);
...
var require_dns = __commonJS({
  "../../node_modules/undici/lib/interceptor/dns.js"(exports, module2) {
    "use strict";
    ...
    var _maxTTL, _maxItems, _records, _defaultLookup, defaultLookup_fn, _defaultPick, defaultPick_fn;
    var DNSInstance = class {
      constructor(opts) {
        __privateAdd(this, _defaultLookup);
        __privateAdd(this, _defaultPick);
        ...
        this.lookup = opts.lookup ?? __privateMethod(this, _defaultLookup, defaultLookup_fn);
        this.pick = opts.pick ?? __privateMethod(this, _defaultPick, defaultPick_fn);
      }
      get full() {
      ...
      pickFamily(origin, ipFamily) {
        var _a;
        const records = (_a = __privateGet(this, _records).get(origin.hostname)) == null ? void 0 : _a.records;
        if (!records) {
          return null;
        }
    ...
    var _state, _opts, _dispatch, _origin, _controller, _newOrigin, _firstTry;
...
var require_cache = __commonJS({
  "../../node_modules/undici/lib/util/cache.js"(exports, module2) {
    "use strict";
    var {
      safeHTTPMethods
    } = require_util();
...
var require_date = __commonJS({
  "../../node_modules/undici/lib/util/date.js"(exports, module2) {
    "use strict";
...
var require_cache_handler = __commonJS({
  "../../node_modules/undici/lib/handler/cache-handler.js"(exports, module2) {
    "use strict";
    var util = require_util();
    var {
      parseCacheControlHeader,
    ...
    var _cacheKey, _cacheType, _cacheByDefault, _store, _handler, _writeStream;
    var CacheHandler = class {
      ...
      constructor({ store, type, cacheByDefault }, cacheKey, handler) {
         ...
         */
        __privateAdd(this, _cacheKey, void 0);
        /**
         * @type {import('../../types/cache-interceptor.d.ts').default.CacheHandlerOptions['type']}
         */
        __privateAdd(this, _cacheType, void 0);
        /**
         * @type {number | undefined}
         */
        __privateAdd(this, _cacheByDefault, void 0);
        /**
         ...
         */
        __privateAdd(this, _writeStream, void 0);
      ...
      onRequestStart(controller, context) {
        var _a, _b, _c;
        (_a = __privateGet(this, _writeStream)) == null ? void 0 : _a.destroy();
        __privateSet(this, _writeStream, void 0);
        (_c = (_b = __privateGet(this, _handler)).onRequestStart) == null ? void 0 : _c.call(_b, controller, context);
      }
      onRequestUpgrade(controller, statusCode, headers, socket) {
        var _a, _b;
        (_b = (_a = __privateGet(this, _handler)).onRequestUpgrade) == null ? void 0 : _b.call(_a, controller, statusCode, headers, socket);
      }
      /**
      ...
      onResponseStart(controller, statusCode, resHeaders, statusMessage) {
        ...
        const downstreamOnHeaders = () => {
          var _a2, _b2;
          return (_b2 = (_a2 = __privateGet(this, _handler)).onResponseStart) == null ? void 0 : _b2.call(
            _a2,
            controller,
            statusCode,
            resHeaders,
        ...
        if (!util.safeHTTPMethods.includes(__privateGet(this, _cacheKey).method) && statusCode >= 200 && statusCode <= 399) {
          try {
            (_b = (_a = __privateGet(this, _store).delete(__privateGet(this, _cacheKey))) == null ? void 0 : _a.catch) == null ? void 0 : _b.call(_a, noop);
          } catch {
          }
      ...
      onResponseData(controller, chunk) {
        var _a, _b, _c;
        if (((_a = __privateGet(this, _writeStream)) == null ? void 0 : _a.write(chunk)) === false) {
          controller.pause();
        }
        (_c = (_b = __privateGet(this, _handler)).onResponseData) == null ? void 0 : _c.call(_b, controller, chunk);
      }
      onResponseEnd(controller, trailers) {
        var _a, _b, _c;
        (_a = __privateGet(this, _writeStream)) == null ? void 0 : _a.end();
        (_c = (_b = __privateGet(this, _handler)).onResponseEnd) == null ? void 0 : _c.call(_b, controller, trailers);
      }
      onResponseError(controller, err) {
        var _a, _b, _c;
        (_a = __privateGet(this, _writeStream)) == null ? void 0 : _a.destroy(err);
        __privateSet(this, _writeStream, void 0);
        (_c = (_b = __privateGet(this, _handler)).onResponseError) == null ? void 0 : _c.call(_b, controller, err);
      }
    };
    _cacheKey = new WeakMap();
    _cacheType = new WeakMap();
    _cacheByDefault = new WeakMap();
    _store = new WeakMap();
...
var require_memory_cache_store = __commonJS({
  "../../node_modules/undici/lib/cache/memory-cache-store.js"(exports, module2) {
    "use strict";
    var { Writable } = require("stream");
    var { EventEmitter } = require("events");
    var { assertCacheKey, assertCacheValue } = require_cache();
    var _maxCount, _maxSize, _maxEntrySize, _size, _count, _entries, _hasEmittedMaxSizeEvent;
    var MemoryCacheStore = class extends EventEmitter {
      ...
      constructor(opts) {
        ...
        if (opts) {
          ...
          if (opts.maxSize !== void 0) {
            ...
            __privateSet(this, _maxSize, opts.maxSize);
          }
       ...
       */
      isFull() {
        return __privateGet(this, _size) >= __privateGet(this, _maxSize) || __privateGet(this, _count) >= __privateGet(this, _maxCount);
      }
      /**
      ...
      get(key) {
        ...
        const now = Date.now();
        const entries = __privateGet(this, _entries).get(topLevelKey);
        ...
        return new Writable({
          ...
          final(callback) {
            ...
            if (previousEntry) {
              ...
              __privateSet(store, _size, __privateGet(store, _size) - previousEntry.size);
            } else {
              entries.push(entry);
              __privateSet(store, _count, __privateGet(store, _count) + 1);
            }
            __privateSet(store, _size, __privateGet(store, _size) + entry.size);
            if (__privateGet(store, _size) > __privateGet(store, _maxSize) || __privateGet(store, _count) > __privateGet(store, _maxCount)) {
              if (!__privateGet(store, _hasEmittedMaxSizeEvent)) {
                store.emit("maxSizeExceeded", {
                  size: __privateGet(store, _size),
                  maxSize: __privateGet(store, _maxSize),
              ...
              for (const [key2, entries2] of __privateGet(store, _entries)) {
                for (const entry2 of entries2.splice(0, entries2.length / 2)) {
                  __privateSet(store, _size, __privateGet(store, _size) - entry2.size);
                  __privateSet(store, _count, __privateGet(store, _count) - 1);
                }
      ...
      delete(key) {
        ...
        for (const entry of __privateGet(this, _entries).get(topLevelKey) ?? []) {
          __privateSet(this, _size, __privateGet(this, _size) - entry.size);
    ...
    _maxSize = new WeakMap();
    _maxEntrySize = new WeakMap();
    _size = new WeakMap();
    _count = new WeakMap();
    _entries = new WeakMap();
    _hasEmittedMaxSizeEvent = new WeakMap();
...
var require_cache_revalidation_handler = __commonJS({
  "../../node_modules/undici/lib/handler/cache-revalidation-handler.js"(exports, module2) {
    "use strict";
    var assert = require("assert");
    var _successful, _callback, _handler, _context, _allowErrorStatusCodes;
    var CacheRevalidationHandler = class {
      ...
      constructor(callback, handler, allowErrorStatusCodes) {
         ...
         * @type {boolean}
         */
        __privateAdd(this, _allowErrorStatusCodes, void 0);
        if (typeof callback !== "function") {
      ...
      onResponseStart(controller, statusCode, headers, statusMessage) {
        var _a, _b, _c, _d;
        assert(__privateGet(this, _callback) != null);
        ...
        (_b = (_a = __privateGet(this, _handler)).onRequestStart) == null ? void 0 : _b.call(_a, controller, __privateGet(this, _context));
        (_d = (_c = __privateGet(this, _handler)).onResponseStart) == null ? void 0 : _d.call(
          _c,
          controller,
          statusCode,
          headers,
      ...
      onResponseData(controller, chunk) {
        ...
        return (_b = (_a = __privateGet(this, _handler)).onResponseData) == null ? void 0 : _b.call(_a, controller, chunk);
      }
      onResponseEnd(controller, trailers) {
        var _a, _b;
        if (__privateGet(this, _successful)) {
        ...
        (_b = (_a = __privateGet(this, _handler)).onResponseEnd) == null ? void 0 : _b.call(_a, controller, trailers);
      }
      onResponseError(controller, err) {
        if (__privateGet(this, _successful)) {
          return;
        ...
        if (typeof __privateGet(this, _handler).onResponseError === "function") {
          __privateGet(this, _handler).onResponseError(controller, err);
        } else {
          throw err;
        }
      }
    };
    _successful = new WeakMap();
    _callback = new WeakMap();
    _handler = new WeakMap();
    _context = new WeakMap();
    _allowErrorStatusCodes = new WeakMap();
...
var require_cache2 = __commonJS({
  "../../node_modules/undici/lib/interceptor/cache.js"(exports, module2) {
    "use strict";
    var assert = require("assert");
    var { Readable } = require("stream");
    var util = require_util();
    ...
    function needsRevalidation(result, cacheControlDirectives) {
      ...
      if (((_a = result.cacheControlDirectives) == null ? void 0 : _a["no-cache"]) && !Array.isArray(result.cacheControlDirectives["no-cache"])) {
        return true;
      }
      const now = Date.now();
    ...
    function sendCachedValue(handler, opts, result, age, context, isStale) {
      ...
      stream.on("error", function(err) {
        ...
        var _a2;
        if (!this.errored) {
          (_a2 = handler.onResponseEnd) == null ? void 0 : _a2.call(handler, controller, {});
        }
      });
      (_a = handler.onRequestStart) == null ? void 0 : _a.call(handler, controller, context);
      if (stream.destroyed) {
        return;
      }
      ...
      if (opts.method === "HEAD") {
        ...
        stream.on("data", function(chunk) {
          var _a2;
          (_a2 = handler.onResponseData) == null ? void 0 : _a2.call(handler, controller, chunk);
        });
      }
    }
    ...
    module2.exports = (opts = {}) => {
      ...
      return (dispatch) => {
        return (opts2, handler) => {
          ...
          const reqCacheControl = ((_a = opts2.headers) == null ? void 0 : _a["cache-control"]) ? parseCacheControlHeader(opts2.headers["cache-control"]) : void 0;
...
var require_sqlite_cache_store = __commonJS({
  "../../node_modules/undici/lib/cache/sqlite-cache-store.js"(exports, module2) {
    "use strict";
    var { Writable } = require("stream");
    var { assertCacheKey, assertCacheValue } = require_cache();
    var DatabaseSync;
    ...
    var _maxEntrySize, _maxCount, _db, _getValuesQuery, _updateValueQuery, _insertValueQuery, _deleteExpiredValuesQuery, _deleteByUrlQuery, _countEntriesQuery, _deleteOldValuesQuery, _prune, prune_fn, _makeValueUrl, makeValueUrl_fn, _findValue, findValue_fn, _a;
    module2.exports = (_a = class {
      /**
       * @param {import('../../types/cache-interceptor.d.ts').default.SqliteCacheStoreOpts | undefined} opts
       */
      constructor(opts) {
        __privateAdd(this, _prune);
        /**
         * @param {import('../../types/cache-interceptor.d.ts').default.CacheKey} key
         * @returns {string}
         */
        __privateAdd(this, _makeValueUrl);
        /**
         * @param {import('../../types/cache-interceptor.d.ts').default.CacheKey} key
         * @param {boolean} [canBeExpired=false]
         * @returns {SqliteStoreValue | undefined}
         */
        __privateAdd(this, _findValue);
        __privateAdd(this, _maxEntrySize, MAX_ENTRY_SIZE);
        __privateAdd(this, _maxCount, Infinity);
        /**
         ...
         */
        __privateAdd(this, _getValuesQuery, void 0);
        /**
         * @type {import('node:sqlite').StatementSync}
         */
        __privateAdd(this, _updateValueQuery, void 0);
        /**
         * @type {import('node:sqlite').StatementSync}
         */
        __privateAdd(this, _insertValueQuery, void 0);
        /**
         * @type {import('node:sqlite').StatementSync}
         */
        __privateAdd(this, _deleteExpiredValuesQuery, void 0);
        /**
         * @type {import('node:sqlite').StatementSync}
         */
        __privateAdd(this, _deleteByUrlQuery, void 0);
        /**
         * @type {import('node:sqlite').StatementSync}
         */
        __privateAdd(this, _countEntriesQuery, void 0);
        /**
         * @type {import('node:sqlite').StatementSync | null}
         */
        __privateAdd(this, _deleteOldValuesQuery, void 0);
        if (opts) {
          if (typeof opts !== "object") {
    ...
    `));
        ...
        __privateSet(this, _deleteOldValuesQuery, __privateGet(this, _maxCount) === Infinity ? null : __privateGet(this, _db).prepare(`
      ...
      get(key) {
        assertCacheKey(key);
        const value = __privateMethod(this, _findValue, findValue_fn).call(this, key);
        return value ? {
      ...
      set(key, value) {
        assertCacheKey(key);
        const url = __privateMethod(this, _makeValueUrl, makeValueUrl_fn).call(this, key);
        const body = Array.isArray(value.body) ? Buffer.concat(value.body) : value.body;
        const size = body == null ? void 0 : body.byteLength;
        if (size && size > __privateGet(this, _maxEntrySize)) {
          return;
        }
        const existingValue = __privateMethod(this, _findValue, findValue_fn).call(this, key, true);
        if (existingValue) {
          ...
          __privateMethod(this, _prune, prune_fn).call(this);
      ...
      createWriteStream(key, value) {
        ...
        return new Writable({
          ...
          write(chunk, encoding, callback) {
            ...
            if (size < __privateGet(store, _maxEntrySize)) {
              body.push(chunk);
            } else {
              this.destroy();
            }
      ...
      delete(key) {
        ...
        __privateGet(this, _deleteByUrlQuery).run(__privateMethod(this, _makeValueUrl, makeValueUrl_fn).call(this, key));
      }
      /**
    ...
    }, _maxEntrySize = new WeakMap(), _maxCount = new WeakMap(), _db = new WeakMap(), _getValuesQuery = new WeakMap(), _updateValueQuery = new WeakMap(), _insertValueQuery = new WeakMap(), _deleteExpiredValuesQuery = new WeakMap(), _deleteByUrlQuery = new WeakMap(), _countEntriesQuery = new WeakMap(), _deleteOldValuesQuery = new WeakMap(), _prune = new WeakSet(), prune_fn = function() {
      var _a2;
      if (Number.isFinite(__privateGet(this, _maxCount)) && this.size <= __privateGet(this, _maxCount)) {
        return 0;
      }
      {
      ...
      {
        const removed = (_a2 = __privateGet(this, _deleteOldValuesQuery)) == null ? void 0 : _a2.run(Math.max(Math.floor(__privateGet(this, _maxCount) * 0.1), 1)).changes;
        if (removed) {
          return removed;
        }
      }
      return 0;
    }, _makeValueUrl = new WeakSet(), makeValueUrl_fn = function(key) {
      return `${key.origin}/${key.path}`;
    }, _findValue = new WeakSet(), findValue_fn = function(key, canBeExpired = false) {
      const url = __privateMethod(this, _makeValueUrl, makeValueUrl_fn).call(this, key);
  ...
  "../../node_modules/undici/lib/web/fetch/headers.js"(exports, module2) {
    ...
    var HeadersList = class _HeadersList {
      ...
      get(name, isLowerCase) {
        var _a;
        return ((_a = this.headersMap.get(isLowerCase ? name : name.toLowerCase())) == null ? void 0 : _a.value) ?? null;
      }
      *[Symbol.iterator]() {
  ...
  "../../node_modules/undici/lib/web/fetch/response.js"(exports, module2) {
    ...
    var _Response = class _Response {
      ...
      constructor(body = null, init = void 0) {
        ...
        __privateSet(this, _state, makeResponse({}));
        __privateSet(this, _headers, new Headers(kConstruct));
        setHeadersGuard(__privateGet(this, _headers), "response");
        setHeadersList(__privateGet(this, _headers), __privateGet(this, _state).headersList);
      ...
      static redirect(url, status = 302) {
        ...
        __privateGet(responseObject, _state).status = status;
        const value = isomorphicEncode(URLSerializer(parsedURL));
        __privateGet(responseObject, _state).headersList.append("location", value, true);
        return responseObject;
      }
      // Returns response’s type, e.g., "cors".
      get type() {
        webidl.brandCheck(this, _Response);
        return __privateGet(this, _state).type;
      }
      // Returns response’s URL, if it has one; otherwise the empty string.
      get url() {
        webidl.brandCheck(this, _Response);
        const urlList = __privateGet(this, _state).urlList;
      ...
      get redirected() {
        webidl.brandCheck(this, _Response);
        return __privateGet(this, _state).urlList.length > 1;
      }
      ...
      get ok() {
        webidl.brandCheck(this, _Response);
        return __privateGet(this, _state).status >= 200 && __privateGet(this, _state).status <= 299;
      }
      // Returns response’s status message.
      get statusText() {
        webidl.brandCheck(this, _Response);
        return __privateGet(this, _state).statusText;
      }
      ...
      get body() {
        webidl.brandCheck(this, _Response);
        return __privateGet(this, _state).body ? __privateGet(this, _state).body.stream : null;
      }
      get bodyUsed() {
        webidl.brandCheck(this, _Response);
        return !!__privateGet(this, _state).body && util.isDisturbed(__privateGet(this, _state).body.stream);
      }
      // Returns a clone of response.
      clone() {
        webidl.brandCheck(this, _Response);
        if (bodyUnusable(__privateGet(this, _state))) {
          throw webidl.errors.exception({
      ...
      static getResponseHeaders(response) {
        return __privateGet(response, _headers);
      }
      /**
       * @param {Response} response
      ...
      static setResponseHeaders(response, newHeaders) {
        __privateSet(response, _headers, newHeaders);
      }
      /**
       * @param {Response} response
       */
      static getResponseState(response) {
        return __privateGet(response, _state);
      }
      /**
       * @param {Response} response
       * @param {any} newState
      ...
      static setResponseState(response, newState) {
        __privateSet(response, _state, newState);
      }
    };
    _headers = new WeakMap();
    _state = new WeakMap();
    ...
    var _Request = class _Request {
      ...
      constructor(input, init = void 0) {
        ...
        if (typeof input === "string") {
          ...
          request = __privateGet(input, _state);
        ...
        __privateSet(this, _state, request);
        ...
        __privateSet(this, _headers, new Headers(kConstruct));
        setHeadersList(__privateGet(this, _headers), request.headersList);
        setHeadersGuard(__privateGet(this, _headers), "request");
        if (mode === "no-cors") {
          ...
          setHeadersGuard(__privateGet(this, _headers), "request-no-cors");
        }
        if (initHasKey) {
          const headersList = getHeadersList(__privateGet(this, _headers));
          ...
          if (headers instanceof HeadersList) {
            ...
            fillHeaders(__privateGet(this, _headers), headers);
          }
        }
        const inputBody = webidl.is.Request(input) ? __privateGet(input, _state).body : null;
        ...
        if (init.body != null) {
          ...
          if (contentType && !getHeadersList(__privateGet(this, _headers)).contains("content-type", true)) {
            __privateGet(this, _headers).append("content-type", contentType, true);
          }
        }
        ...
        if (initBody == null && inputBody != null) {
          if (bodyUnusable(__privateGet(input, _state))) {
            throw new TypeError(
        ...
        __privateGet(this, _state).body = finalBody;
      }
      // Returns request’s HTTP method, which is "GET" by default.
      get method() {
        webidl.brandCheck(this, _Request);
        return __privateGet(this, _state).method;
      }
      // Returns the URL of request as a string.
      get url() {
        webidl.brandCheck(this, _Request);
        return URLSerializer(__privateGet(this, _state).url);
      }
      ...
      get destination() {
        webidl.brandCheck(this, _Request);
        return __privateGet(this, _state).destination;
      }
      ...
      get referrer() {
        webidl.brandCheck(this, _Request);
        if (__privateGet(this, _state).referrer === "no-referrer") {
          return "";
        }
        if (__privateGet(this, _state).referrer === "client") {
          return "about:client";
        }
        return __privateGet(this, _state).referrer.toString();
      }
      ...
      get referrerPolicy() {
        webidl.brandCheck(this, _Request);
        return __privateGet(this, _state).referrerPolicy;
      }
      ...
      get mode() {
        webidl.brandCheck(this, _Request);
        return __privateGet(this, _state).mode;
      }
      ...
      get credentials() {
        webidl.brandCheck(this, _Request);
        return __privateGet(this, _state).credentials;
      }
      ...
      get cache() {
        webidl.brandCheck(this, _Request);
        return __privateGet(this, _state).cache;
      }
      ...
      get redirect() {
        webidl.brandCheck(this, _Request);
        return __privateGet(this, _state).redirect;
      }
      ...
      get integrity() {
        webidl.brandCheck(this, _Request);
        return __privateGet(this, _state).integrity;
      }
      // Returns a boolean indicating whether or not request can outlive the
      // global in which it was created.
      get keepalive() {
        webidl.brandCheck(this, _Request);
        return __privateGet(this, _state).keepalive;
      }
      // Returns a boolean indicating whether or not request is for a reload
      // navigation.
      get isReloadNavigation() {
        webidl.brandCheck(this, _Request);
        return __privateGet(this, _state).reloadNavigation;
      }
      // Returns a boolean indicating whether or not request is for a history
      // navigation (a.k.a. back-forward navigation).
      get isHistoryNavigation() {
        webidl.brandCheck(this, _Request);
        return __privateGet(this, _state).historyNavigation;
      }
      ...
      clone() {
        ...
        const clonedRequest = cloneRequest(__privateGet(this, _state));
        const ac = new AbortController();
      ...
      static setRequestSignal(request, newSignal) {
        __privateSet(request, _signal, newSignal);
        return request;
      }
      /**
       * @param {Request} request
      ...
      static getRequestDispatcher(request) {
        return __privateGet(request, _dispatcher);
      }
      /**
       * @param {Request} request
      ...
      static setRequestDispatcher(request, newDispatcher) {
        __privateSet(request, _dispatcher, newDispatcher);
      }
      /**
       * @param {Request} request
       * @param {Headers} newHeaders
      ...
      static setRequestHeaders(request, newHeaders) {
        __privateSet(request, _headers, newHeaders);
      }
      /**
       * @param {Request} request
       */
      static getRequestState(request) {
        return __privateGet(request, _state);
      }
      /**
       * @param {Request} request
       * @param {any} newState
      ...
      static setRequestState(request, newState) {
        __privateSet(request, _state, newState);
      }
    };
    _signal = new WeakMap();
...
var require_fetch = __commonJS({
  "../../node_modules/undici/lib/web/fetch/index.js"(exports, module2) {
    ...
    function abortFetch(p, request, responseObject, error) {
      ...
      if (((_a = request.body) == null ? void 0 : _a.stream) != null && isReadable(request.body.stream)) {
...
var require_parse = __commonJS({
  "../../node_modules/undici/lib/web/cookies/parse.js"(exports, module2) {
    ...
    var assert = require("assert");
    var { unescape } = require("querystring");
...
var require_connection = __commonJS({
  "../../node_modules/undici/lib/web/websocket/connection.js"(exports, module2) {
    ...
    function failWebsocketConnection(handler, code, reason) {
      ...
      if (((_a = handler.socket) == null ? void 0 : _a.destroyed) === false) {
    ...
    var ByteParser = class extends Writable {
        ...
        while (__privateGet(this, _loop)) {
          if (__privateGet(this, _state) === parserStates.INFO) {
            ...
            if (!isValidOpcode(opcode)) {
              failWebsocketConnection(__privateGet(this, _handler), 1002, "Invalid opcode received");
              return callback();
            }
            if (masked) {
              failWebsocketConnection(__privateGet(this, _handler), 1002, "Frame cannot be masked");
              return callback();
            }
            if (rsv1 !== 0 && !__privateGet(this, _extensions).has("permessage-deflate")) {
              failWebsocketConnection(__privateGet(this, _handler), 1002, "Expected RSV1 to be clear.");
              return;
            }
            if (rsv2 !== 0 || rsv3 !== 0) {
              failWebsocketConnection(__privateGet(this, _handler), 1002, "RSV1, RSV2, RSV3 must be clear");
              return;
            }
            if (fragmented && !isTextBinaryFrame(opcode)) {
              failWebsocketConnection(__privateGet(this, _handler), 1002, "Invalid frame type was fragmented.");
              return;
            }
            if (isTextBinaryFrame(opcode) && __privateGet(this, _fragments).length > 0) {
              failWebsocketConnection(__privateGet(this, _handler), 1002, "Expected continuation frame");
              return;
            }
            if (__privateGet(this, _info).fragmented && fragmented) {
              failWebsocketConnection(__privateGet(this, _handler), 1002, "Fragmented frame exceeded 125 bytes.");
              return;
            }
            if ((payloadLength > 125 || fragmented) && isControlFrame(opcode)) {
              failWebsocketConnection(__privateGet(this, _handler), 1002, "Control frame either too large or fragmented");
              return;
            }
            if (isContinuationFrame(opcode) && __privateGet(this, _fragments).length === 0 && !__privateGet(this, _info).compressed) {
              failWebsocketConnection(__privateGet(this, _handler), 1002, "Unexpected continuation frame");
              return;
            }
            ...
            if (isControlFrame(__privateGet(this, _info).opcode)) {
              ...
              if (!__privateGet(this, _info).compressed) {
                ...
                if (!__privateGet(this, _info).fragmented && __privateGet(this, _info).fin) {
                  websocketMessageReceived(__privateGet(this, _handler), __privateGet(this, _info).binaryType, this.consumeFragments());
                }
                __privateSet(this, _state, parserStates.INFO);
              } else {
      ...
      parseControlFrame(body) {
        ...
        if (opcode === opcodes.CLOSE) {
          if (payloadLength === 1) {
            failWebsocketConnection(__privateGet(this, _handler), 1002, "Received close frame with a 1-byte body.");
            return false;
          }
          ...
          if (__privateGet(this, _info).closeInfo.error) {
            ...
            failWebsocketConnection(__privateGet(this, _handler), code, reason);
            return false;
          }
          if (!__privateGet(this, _handler).closeState.has(sentCloseFrameState.SENT) && !__privateGet(this, _handler).closeState.has(sentCloseFrameState.RECEIVED)) {
            ...
            __privateGet(this, _handler).socket.write(closeFrame.createFrame(opcodes.CLOSE));
            __privateGet(this, _handler).closeState.add(sentCloseFrameState.SENT);
          }
          __privateGet(this, _handler).readyState = states.CLOSING;
          __privateGet(this, _handler).closeState.add(sentCloseFrameState.RECEIVED);
          return false;
        } else if (opcode === opcodes.PING) {
          if (!__privateGet(this, _handler).closeState.has(sentCloseFrameState.RECEIVED)) {
            const frame = new WebsocketFrameSend(body);
            __privateGet(this, _handler).socket.write(frame.createFrame(opcodes.PONG));
        ...
        if (hint !== sendHints.blob) {
          if (!__privateGet(this, _running)) {
            if (hint === sendHints.text) {
              ...
              __privateGet(this, _socket).write(body, cb);
...
var require_websocket = __commonJS({
  "../../node_modules/undici/lib/web/websocket/websocket.js"(exports, module2) {
    ...
    var { channels } = require_diagnostics();
    var _events, _bufferedAmount, _protocol, _extensions, _sendQueue, _handler, _url, _binaryType, _parser, _onConnectionEstablished, onConnectionEstablished_fn, _onFail, onFail_fn, _onMessage, onMessage_fn, _onParserDrain, onParserDrain_fn, _onSocketClose, onSocketClose_fn;
    var _WebSocket = class _WebSocket extends EventTarget {
      ...
      constructor(url, protocols = []) {
        ...
        __privateAdd(this, _onFail);
        __privateAdd(this, _onMessage);
        __privateAdd(this, _onParserDrain);
        /**
         * @see https://websockets.spec.whatwg.org/#feedback-from-the-protocol
        ...
        __privateAdd(this, _handler, {
          onConnectionEstablished: (response, extensions) => __privateMethod(this, _onConnectionEstablished, onConnectionEstablished_fn).call(this, response, extensions),
          onFail: (code, reason) => __privateMethod(this, _onFail, onFail_fn).call(this, code, reason),
          onMessage: (opcode, data) => __privateMethod(this, _onMessage, onMessage_fn).call(this, opcode, data),
          onParserError: (err) => failWebsocketConnection(__privateGet(this, _handler), null, err.message),
          onParserDrain: () => __privateMethod(this, _onParserDrain, onParserDrain_fn).call(this),
          onSocketData: (chunk) => {
            if (!__privateGet(this, _parser).write(chunk)) {
              __privateGet(this, _handler).socket.pause();
            }
          },
          onSocketError: (err) => {
            __privateGet(this, _handler).readyState = states.CLOSING;
            ...
            __privateGet(this, _handler).socket.destroy();
          },
          onSocketClose: () => __privateMethod(this, _onSocketClose, onSocketClose_fn).call(this),
        ...
        __privateAdd(this, _binaryType, void 0);
        ...
        __privateGet(this, _handler).controller = establishWebSocketConnection(
          ...
          protocols,
          client,
          __privateGet(this, _handler),
          options
        );
        __privateGet(this, _handler).readyState = _WebSocket.CONNECTING;
      ...
      close(code = void 0, reason = void 0) {
        ...
        code ?? (code = null);
        reason ?? (reason = "");
        closeWebSocketConnection(__privateGet(this, _handler), code, reason, true);
      }
      /**
      ...
      send(data) {
        ...
        if (isConnecting(__privateGet(this, _handler).readyState)) {
          throw new DOMException("Sent before connected.", "InvalidStateError");
        }
        if (!isEstablished(__privateGet(this, _handler).readyState) || isClosing(__privateGet(this, _handler).readyState)) {
          return;
        }
      ...
      get readyState() {
        webidl.brandCheck(this, _WebSocket);
        return __privateGet(this, _handler).readyState;
      }
      get bufferedAmount() {
        webidl.brandCheck(this, _WebSocket);
    ...
    onConnectionEstablished_fn = function(response, parsedExtensions) {
      ...
      __privateGet(this, _handler).readyState = states.OPEN;
    ...
    onFail_fn = function(code, reason) {
      ...
      if (!__privateGet(this, _handler).wasEverConnected) {
        __privateGet(this, _handler).readyState = states.CLOSED;
    ...
    onMessage_fn = function(type, data) {
      if (__privateGet(this, _handler).readyState !== states.OPEN) {
        return;
      }
      let dataForEvent;
      if (type === opcodes.TEXT) {
        try {
          ...
          failWebsocketConnection(__privateGet(this, _handler), 1007, "Received invalid UTF-8 in text frame.");
          return;
        }
    ...
    _onParserDrain = new WeakSet();
    onParserDrain_fn = function() {
      __privateGet(this, _handler).socket.resume();
    };
    _onSocketClose = new WeakSet();
    onSocketClose_fn = function() {
      const wasClean = __privateGet(this, _handler).closeState.has(sentCloseFrameState.SENT) && __privateGet(this, _handler).closeState.has(sentCloseFrameState.RECEIVED);
      let code = 1005;
      let reason = "";
      ...
      } else if (!__privateGet(this, _handler).closeState.has(sentCloseFrameState.RECEIVED)) {
        code = 1006;
      }
      __privateGet(this, _handler).readyState = states.CLOSED;
      fireEvent("close", this, (type, init) => new CloseEvent(type, init), {
...
var require_websocketerror = __commonJS({
  "../../node_modules/undici/lib/web/websocket/stream/websocketerror.js"(exports, module2) {
    "use strict";
    var { webidl } = require_webidl();
    var { validateCloseCodeAndReason } = require_util5();
    var { kConstruct } = require_symbols();
    var { kEnumerableProperty } = require_util();
    var _closeCode, _reason;
    var _WebSocketError = class _WebSocketError extends DOMException {
      constructor(message = "", init = void 0) {
        message = webidl.converters.DOMString(message, "WebSocketError", "message");
        super(message, "WebSocketError");
        __privateAdd(this, _closeCode, void 0);
      ...
      static createUnvalidatedWebSocketError(message, code, reason) {
        ...
        __privateSet(error, _reason, reason);
        return error;
      }
    };
...
var require_websocketstream = __commonJS({
  "../../node_modules/undici/lib/web/websocket/stream/websocketstream.js"(exports, module2) {
    "use strict";
    ...
    var _url, _openedPromise, _closedPromise, _readableStream, _readableStreamController, _writableStream, _handshakeAborted, _handler, _parser, _write, write_fn, _onConnectionEstablished, onConnectionEstablished_fn, _onMessage, onMessage_fn, _onSocketClose, onSocketClose_fn, _closeUsingReason, closeUsingReason_fn, _cancel, cancel_fn;
    var WebSocketStream = class {
      constructor(url, options = void 0) {
        ...
        __privateAdd(this, _onSocketClose);
        __privateAdd(this, _closeUsingReason);
        ...
        __privateAdd(this, _openedPromise, void 0);
        // Each WebSocketStream object has an associated closed promise , which is a promise.
        /** @type {ReturnType<typeof createDeferredPromise>} */
        __privateAdd(this, _closedPromise, void 0);
        // Each WebSocketStream object has an associated readable stream , which is a ReadableStream .
        /** @type {ReadableStream} */
        __privateAdd(this, _readableStream, void 0);
        /** @type {ReadableStreamDefaultController} */
        __privateAdd(this, _readableStreamController, void 0);
        // Each WebSocketStream object has an associated writable stream , which is a WritableStream .
        /** @type {WritableStream} */
        __privateAdd(this, _writableStream, void 0);
        ...
        __privateAdd(this, _handler, {
          ...
          onMessage: (opcode, data) => __privateMethod(this, _onMessage, onMessage_fn).call(this, opcode, data),
          onParserError: (err) => failWebsocketConnection(__privateGet(this, _handler), null, err.message),
          onParserDrain: () => __privateGet(this, _handler).socket.resume(),
          onSocketData: (chunk) => {
            if (!__privateGet(this, _parser).write(chunk)) {
              __privateGet(this, _handler).socket.pause();
            }
        ...
        if (options.signal != null) {
          ...
          signal.addEventListener("abort", () => {
            if (!isEstablished(__privateGet(this, _handler).readyState)) {
              failWebsocketConnection(__privateGet(this, _handler));
              __privateGet(this, _handler).readyState = states.CLOSING;
              __privateGet(this, _openedPromise).reject(signal.reason);
              __privateGet(this, _closedPromise).reject(signal.reason);
    ...
    write_fn = function(chunk) {
      ...
      if (!__privateGet(this, _handler).closeState.has(sentCloseFrameState.SENT) && !__privateGet(this, _handler).closeState.has(sentCloseFrameState.RECEIVED)) {
        ...
        __privateGet(this, _handler).socket.write(frame.createFrame(opcode), () => {
    ...
    onConnectionEstablished_fn = function(response, parsedExtensions) {
      ...
      const readable = new ReadableStream({
        ...
        cancel: (reason) => __privateMethod(this, _cancel, cancel_fn).call(this, reason)
      });
      const writable = new WritableStream({
        write: (chunk) => __privateMethod(this, _write, write_fn).call(this, chunk),
        close: () => closeWebSocketConnection(__privateGet(this, _handler), null, null),
        abort: (reason) => __privateMethod(this, _closeUsingReason, closeUsingReason_fn).call(this, reason)
      });
      __privateSet(this, _readableStream, readable);
    ...
    onMessage_fn = function(type, data) {
      ...
      if (type === opcodes.TEXT) {
        try {
          ...
          failWebsocketConnection(__privateGet(this, _handler), "Received invalid UTF-8 in text frame.");
          return;
        }
      } else if (type === opcodes.BINARY) {
    ...
    closeUsingReason_fn = function(reason) {
      ...
      closeWebSocketConnection(__privateGet(this, _handler), code, reasonString);
    };
    _cancel = new WeakSet();
    cancel_fn = function(reason) {
      __privateMethod(this, _closeUsingReason, closeUsingReason_fn).call(this, reason);
    };
...
async function video_by_id_parse(body) {
