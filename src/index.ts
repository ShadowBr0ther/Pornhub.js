...
export type { ChannelsPage } from './scrapers/pages/channels';
export type { UsersPage } from './scrapers/pages/users';
...
export class PornHub {
     ...
     * @param urlOrName Pornstar name or page url
     */
    pornstarVideo(urlOrName: string, page = 1) {
     ...
     * @param urlOrName Model name or page url
     */
    modelVideo(urlOrName: string, page = 1, startPageFix = false) {
     ...
     * @param urlOrName Channel name or page url
     */
    channelsVideo(urlOrName: string, page = 1) {
