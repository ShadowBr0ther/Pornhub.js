...
export const Route = {
     ...
     */
    autocomplete(keyword: string, { token, sexualOrientation = 'straight' }: AutoCompleteOptions) {
    ...
    channelPageWithVideos(name: string) {
    ...
    recommendedPage({ order = 'Most Relevant', page = 1, sexualOrientation = 'straight' }: RecommendedOptions) {
    ...
    gifSearch(
        keyword: string,
        { page = 1, order = 'Most Relevant', sexualOrientation = 'straight' }: GifSearchOptions,
    ) {
    ...
    pornstarSearch(
        keyword: string,
        { page = 1, order = 'Most Relevant', sexualOrientation = 'straight' }: PornstarSearchOptions,
    ) {
    ...
    videoSearch(keyword: string, param: VideoSearchOptions) {
        ...
        return urlcat(BASE_URL, pathTemplate, {
            ...
            ...((param.order === 'Most Viewed' || param.order === 'Top Rated') &&
                param.period &&
                param.period !== 'alltime' && { t: VideoSearchPeriodMapping[param.period] }),
        });
    },
    /**
    ...
    videoList(param: VideoListOptions) {
        ...
        const pathTemplate =
            sexualOrientation === 'transgender' ? 'transgender' : sexualOrientation === 'gay' ? '/gay/video' : '/video';
        ...
        return urlcat(BASE_URL, pathTemplate, {
            ...
            ...(param.order === 'Hottest' &&
                param.country &&
                param.country !== 'World' && { cc: CountryMapping[param.country] }),
            ...(durationMin && { min_duration: durationMin }),
            ...(durationMax && { max_duration: durationMax }),
            ...(hd && { hd: '1' }),
            ...(page !== 1 && { page }),
    ...
    pornstarList(param: PornstarListOptions) {
        ...
        return urlcat(BASE_URL, gay ? '/gay/pornstars' : '/pornstars', {
            ...
            ...(param.order === 'Most Popular' &&
                param.timeRange &&
                param.timeRange !== 'monthly' && {
                    timeRange: PornstarPopularPeriodMapping[param.timeRange],
                }),
            ...(param.order === 'Most Viewed' &&
                param.timeRange &&
                param.timeRange !== 'alltime' && {
